...
path = os.path.join(directory, 'geomaps', '__init__.py')
...
try:
    ...
    sys.exit("GDAL must be installed to use `geomaps`.")
...
setup(
    ...
    license='MIT',
    url='https://gitlab.com/dai-projets/geomaps-landcover',
    ...
    entry_points={'console_scripts': ['geomaps = geomaps.main:main']},
