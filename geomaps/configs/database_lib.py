...
from geomaps.configs.core import (
    Files,
    DataModuleConf,
    TransformsConf,
    Config
)
from geomaps.configs.structured.optimizers import (
    AdadeltaConf,
    AdagradConf,
    AdamaxConf,
    AdamConf,
...
from geomaps.configs.structured.schedulers import (
...
from geomaps.configs.structured.profilers import (
    AdvancedProfilerConf, 
    PassThroughProfilerConf,
    SimpleProfilerConf
)
from geomaps.configs.structured.losses import (
...
from geomaps.configs.structured.callbacks import (
    EarlyStoppingConf,
    GPUStatsMonitorConf,
...
from geomaps.configs.structured.loggers import (
    CSVLoggerConf,
    TensorBoardLoggerConf,
    WandbLoggerConf
)
from geomaps.configs.structured.model import (
    UnetConf,
    LightUnetGeomapsConf,
    MediumUnetGeomapsConf,
    LargeUnetGeomapsConf,
    ResBlockNetGeomapsConf,
    DeepLabGeomapsConf,
    UnetSmpConf,
    DeepLabV3SmpConf,
...
def register_configs()-> None:
    ...
    config_store.store(group='model', name='lightunet', node=LightUnetGeomapsConf)
    config_store.store(group='model', name='mediumunet', node=MediumUnetGeomapsConf)
    config_store.store(group='model', name='largeunet', node=LargeUnetGeomapsConf)
    config_store.store(group='model', name='resblocknet', node=ResBlockNetGeomapsConf)
    config_store.store(group='model', name='deeplab', node=DeepLabGeomapsConf)
