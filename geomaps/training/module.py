...
from geomaps.training.metrics import GeomapsMetrics
...
class SegmentationTask(pl.LightningModule):
    def __init__(
        ...
        # Init metrics
        self.train_metrics: GeomapsMetrics = None
        self.val_metrics: GeomapsMetrics = None
        self.test_metrics: GeomapsMetrics = None
    ...
    def setup(self, stage:str=None):
        ...
        if stage == "fit":
            ...
            self.train_metrics = GeomapsMetrics(num_classes=self.hparams.model.classes,
                                              class_labels=self.hparams.class_labels)
            self.val_metrics = GeomapsMetrics(num_classes=self.hparams.model.classes,
                                            class_labels=self.hparams.class_labels)
            ...
            self.test_metrics = GeomapsMetrics(num_classes=self.hparams.model.classes,
                                             class_labels=self.hparams.class_labels)
            self.test_loss = MeanMetric()

        elif stage == "predict":
            self.predict_epoch_loss, self.predict_epoch_metrics = None, None
            self.predict_metrics = GeomapsMetrics(num_classes=self.hparams.model.classes,
                                                class_labels=self.hparams.class_labels)
    ...
    def step_end(self, step_output:Dict[str, torch.Tensor], loss_meter:MeanMetric, metrics:GeomapsMetrics)-> torch.Tensor:
