...
import numpy as np
from geomaps.data.image import raster_to_ndarray, CollectionDatasetReader
from geomaps.data.transforms import ToDoubleTensor, ToPatchTensor, ToWindowTensor
from geomaps import LOGGER
from geomaps.data.raster import affine_to_ndarray
from geomaps.utils.folder import create_folder
...
class MetricsDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not os.path.basename(mask_file) == os.path.basename(pred_file):
            ...
            raise GeomapsError(ErrorCodes.INVALID_DATASET_PATH,
