...
from geomaps.data.datamodule import SegDataModule
from geomaps.training.module import SegmentationTask
...
def instantiate_trainer(config: Config)-> Trainer:
    ...
    def _instantiate_logger(loggers_config: Optional[DictConfig]=None) -> List[Logger]:
    ...
    def _instantiate_profiler(profiler_config: Optional[DictConfig] = None) -> Optional[Profiler]:
