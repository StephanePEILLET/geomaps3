...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels, classes, bilinear=True, batch_norm=True):
        ...
        # encoder
        self.inc = InputConv(in_channels, 64, batch_norm=self.batch_norm)
...
class LightUNet(nn.Module):
    ...
    def __init__(self, in_channels, classes, bilinear=True, batch_norm=False):
        ...
        # encoder
        self.inc = InputConv(in_channels, 8, batch_norm=self.batch_norm)
...
class MediumUNet(nn.Module):
    ...
    def __init__(self, in_channels, classes, bilinear=True, batch_norm=False):
        ...
        # encoder
        self.inc = InputConv(in_channels, 16, batch_norm=self.batch_norm)
        self.down1 = EncoderConv(16, 32, batch_norm=self.batch_norm)
        self.down2 = EncoderConv(32, 64, batch_norm=self.batch_norm)
        self.down3 = EncoderConv(64, 128, batch_norm=self.batch_norm)
        self.down4 = EncoderConv(128, 256, batch_norm=self.batch_norm)
        # decoder
        self.up1 = DecoderConv(
            256, 128, bilinear=self.bilinear, batch_norm=self.batch_norm
        )
...
class LargeUNet(nn.Module):
    ...
    def __init__(self, in_channels, classes, bilinear=True, batch_norm=False):
        ...
        # encoder
        self.inc = InputConv(in_channels, 32, batch_norm=self.batch_norm)
        self.down1 = EncoderConv(32, 64, batch_norm=self.batch_norm)
        self.down2 = EncoderConv(64, 128, batch_norm=self.batch_norm)
        self.down3 = EncoderConv(128, 256, batch_norm=self.batch_norm)
        self.down4 = EncoderConv(256, 512, batch_norm=self.batch_norm)
        # decoder
        self.up1 = DecoderConv(
            512, 256, bilinear=self.bilinear, batch_norm=self.batch_norm
        )
    ...
    def __init__(
        ...
        if encoder_depth == 18:
            self.encoder = torchvision.models.resnet18(
                pretrained=pretrained, num_classes=classes
            )
